...
from .serializers import CustomUserSerializer, RegistrationOTPSerializer, UserRegistrationSerializer
...
class UserRegistrationAPIView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
                ...
                return Response(
                    {
                        ...
                        "otp_meta": {"resend_available": True, "next_resend_in": 60},
                    },
            ...
            return Response(
                {"detail": str(e), "errors": {"email": [str(e)]}}, status=status.HTTP_403_FORBIDDEN
            )
            ...
            if "email" in e.detail and isinstance(e.detail["email"], list):
                ...
                error_message = (
                    e.detail[first_key][0]
                    if first_key and isinstance(e.detail[first_key], list)
